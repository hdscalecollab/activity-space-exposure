...
full_dir = "C:/Users/jyang/Documents/TWSA_PA/Codes-R/Data/GPS_PA760/rfh_all_points_for_activitySpace_PA760_10272021/"  # lon, lat   ### RFH
# full_dir = "C:/Users/jyang/Documents/TWSA_PA/Codes-R/Data/GPS_PA760/menu_all_points_for_activitySpace_PA760_10272021/"  # lng, lat   ### MENU


### Read .csv file paths to a list
point_files <- list.files(path=full_dir, pattern="*.csv", full.names=TRUE, recursive=FALSE)
# point_files <- point_files[c(1)]
...
# out_dir  = "C:/Users/jyang/Documents/TWSA_PA/Codes-R/DR_Rasters/50cell_200r_daily_MENU_PA760/"
...
for(i in 1:length(point_files)){    #### FULL RUN
  ...
  # unique_dates_forPT <- as.list(unique(D1[[col_dateID]]))[c(1)] #### TESTING
  # unique_dates_forPT <- as.list(unique(D1[[col_dateID]]))[10:11] #### TESTING
